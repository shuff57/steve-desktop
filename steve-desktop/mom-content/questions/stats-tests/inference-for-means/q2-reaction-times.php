// === NAME - DESCRIPTION: Hypothesis Test - Reaction Times - Students identify the correct test, build hypotheses from dropdowns, compute sample means, the test statistic, find the p-value, and state a conclusion. ===
...
/* ---------- 1. Scenario ---------- */
$topic = "A sports scientist wants to know whether athletes who drink an energy drink before a test have different reaction times than those who drink water";
$group1_label = "energy drink group";
$group2_label = "water group";
...
$data1 = rands(185, 255, $n1);
$data2 = rands(220, 300, $n2);
