// === NAME - DESCRIPTION: Hypothesis Test - Daily Steps - Students identify the correct test, build hypotheses from dropdowns, compute sample means, the test statistic, find the p-value, and state a conclusion. ===
...
/* ---------- 1. Scenario ---------- */
$topic = "A health researcher wants to know whether dog owners take more daily steps than non-dog-owners";
$group1_label = "dog owners";
$group2_label = "non-dog-owners";
$measurement = "daily steps";
$unit = "steps";

$n1 = rand(8, 10);
$n2 = rand(8, 10);

$data1 = rands(7500, 11500, $n1);
$data2 = rands(4500, 8500, $n2);
