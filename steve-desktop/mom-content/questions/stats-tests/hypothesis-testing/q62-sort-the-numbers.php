// === NAME - DESCRIPTION: Sort the Numbers - which listed values the test uses, and which is the distractor ===
// === SET QUESTION TYPE TO: multipart ===

// === COMMON CONTROL ===

// A full-test scenario with the numbers given. Parts: (a) choices - which of the listed
// numbers the test actually uses (b) choices - which number is the distractor and why.
