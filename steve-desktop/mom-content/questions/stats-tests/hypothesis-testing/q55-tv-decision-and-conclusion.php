// === NAME - DESCRIPTION: Lab: Television Survey Decision and Conclusion - reject at 5%, worded about the class ===
...
$questions[1] = array(
  "At the 5% significance level there is sufficient evidence to conclude that the mean number of hours of television watched per day by students in this class is less than four.",
  "At the 5% significance level there is not sufficient evidence to conclude that the mean is less than four.",
  "The claim that Americans watch four hours per day is false."
)
$answer[1] = 0
$noshuffle[1] = "all"
...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px;">
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:20px; margin:10px 0; box-shadow:0 4px 6px -1px rgba(0,0,0,0.07),0 2px 4px -2px rgba(0,0,0,0.04);">
    <p style="margin:0;">The <b>Television Survey</b> test produced a p-value of 0.0142 at `alpha = 0.05`.</p>
  </div>
