// === NAME - DESCRIPTION: Chi-square Goodness of Fit (Context 2) - Full workflow with written conclusion in context ===
...
// Decision at alpha = 0.05. Critical values: df=3 -> 7.815, df=4 -> 9.488.

// Scenario 0: college class distribution. obs 105,96,60,39; exp 120,90,60,30. chi^2 = 4.98, df=3, FAIL.
// Scenario 1: weekday accidents uniform. obs 52,38,30,36,44; exp 40 each. chi^2 = 7.00, df=4, FAIL.
// Scenario 2: banner-color click shares equal. obs 70,60,40,30; exp 50 each. chi^2 = 20.00, df=3, REJECT.

$ctxs = array(
  "A college claims its student body is <b>40% freshmen, 30% sophomores, 20% juniors, 10% seniors</b>. In a random sample of <b>300</b> students, the observed counts are <b>105 freshmen, 96 sophomores, 60 juniors, 39 seniors</b>; the expected counts under the claim are <b>120, 90, 60, 30</b>.",
  "A city traffic study expects accidents to be evenly spread across the five weekdays. Of <b>200</b> accidents, the observed Monday-Friday counts are <b>52, 38, 30, 36, 44</b>; the expected counts are <b>40</b> each.",
  "An online store expects its four banner colors to generate equal click shares. Out of <b>200</b> clicks, the observed counts by color are <b>70, 60, 40, 30</b>; the expected counts are <b>50</b> each."
)

$chiVals = array(4.98, 7.00, 20.00)
$dfVals  = array(3, 4, 3)
$reject  = array(0, 0, 1)
$ctxName = array("college", "traffic study", "online store")
$claimText = array("the college's class-level distribution matches the claim", "weekday accidents are uniformly distributed", "the four banner colors get equal click shares")
$crits = array(7.815, 9.488, 7.815)
...
$choices[2] = array(
  ...
  "Reject `H_0`: the chi-square statistic is positive, so we must reject no matter how small it is.",
  "Fail to reject `H_0`: this proves that " . $claim . " is exactly correct."
)
$answer[2] = 1 - $rj
$noshuffle[2] = "all"
...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      <p><b>Part a.</b> For a chi-square goodness-of-fit test, `H_0` says the population matches the claimed distribution; `H_a` says at least one proportion differs. The alternative only says "differs," not a direction.</p>
