...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      ...
      <p><span class="term-label">Part (b) &mdash; what you feed invNorm.</span> `invNorm` wants the area BELOW the value, not the tail above it. The area to the left is `1 - alpha/2 = ' . round($leftArea, 3) . '`, so you run `invNorm(' . round($leftArea, 3) . ', 0, 1)`. The last two arguments stay 0 and 1 because this is the standard normal curve.</p>
