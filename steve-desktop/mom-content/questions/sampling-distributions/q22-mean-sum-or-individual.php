...
$questions[0] = array(
  "The distribution of the individual values (the population distribution itself &mdash; do NOT use the central limit theorem)",
...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      ...
      <p><span class="term-label">Part (a) &mdash; one individual.</span> A question about $singlePhrase is about `X`, the population distribution itself &mdash; the central limit theorem has nothing to say about it. That third case is where most of the lost points in this section live.</p>
      <p><span class="term-label">Part (b) &mdash; a sample mean.</span> A question about $meanPhrase is about `bar(x)`, and the central limit theorem applies: `bar(X) ~ N(mu, sigma/sqrt(n))`.</p>
      <p><span class="term-label">Part (c) &mdash; a sample sum.</span> A question about $sumPhrase is about `Sigma x`, and the central limit theorem for sums applies: `Sigma X ~ N(n*mu, sqrt(n)*sigma)`.</p>
