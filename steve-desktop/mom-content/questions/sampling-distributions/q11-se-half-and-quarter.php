// === NAME - DESCRIPTION: The Standard Error for n and 4n - what quadrupling the sample size does ===
// === SET QUESTION TYPE TO: multipart ===

// === COMMON CONTROL ===

// mu, sigma, and one sample size n with sqrt(n) and sqrt(4n) exact.
// Parts: (a) numfunc - SE for size n (b) numfunc - SE for size 4n.
// Invariant: (a) = sigma/sqrt(n), (b) = (a)/2 exactly on every seed.
