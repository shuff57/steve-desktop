// === NAME - DESCRIPTION: Probability That a Sum Is Greater Than a Value - P(Sigma x > c) ===
...
// Invariant: (a) = n*mu, (b) = 1 - normalcdf((c - n*mu)/(sqrt(n)*sigma)) to 4 decimals.
...
$contexts = array(
  array("an unknown distribution", 45, 8, 50, 2400),
  array("an unknown distribution", 90, 15, 80, 7500),
  array("an unknown distribution", 80, 12, 95, 7650),
  array("the distribution of results from a cholesterol test", 180, 20, 40, 7500)
)
// [ctx, mu, sigma, n, c]
...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px;">
  ...
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:14px 20px; margin:6px 0; box-shadow:0 4px 6px -1px rgba(0,0,0,0.07),0 2px 4px -2px rgba(0,0,0,0.04);">
    <span style="display:inline-block; background:#e8f0fe; color:#1865f2; border-radius:6px; padding:3px 10px; font-size:13px; font-weight:700; margin-right:10px; vertical-align:middle;">b.</span> Find `P(Sigma x > $c)`, the probability that the sum is more than $c. (Round to 4 decimal places.)
