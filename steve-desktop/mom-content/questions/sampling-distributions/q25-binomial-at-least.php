// === NAME - DESCRIPTION: Binomial At Least with the Continuity Correction - P(X >= a) via the corrected boundary ===
...
// Invariant: (a) = a - 0.5 exactly and (b) = 1 - normalcdf((a - 0.5 - mu)/sigma) to 4 decimals
// on every seed.
...
$contexts = array(
  array("favor a charter school for grades K through 5", 300, 0.53, 150),
  array("favor the incumbent, Dawn Morgan, for mayor", 500, 0.46, 250),
  array("have a defective part in a shipment", 200, 0.10, 30)
)
// [ctx, n, p, a]
...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px;">
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:20px; margin:10px 0; box-shadow:0 4px 6px -1px rgba(0,0,0,0.07),0 2px 4px -2px rgba(0,0,0,0.04);">
    <p style="margin:0;">In a survey of `n = $n` people, ' . ($p * 100) . '% $ctx. Let `X` = the number who do, so `X ~ B($n, $p)`. Find the probability that at least $a $ctx, using the normal approximation with the continuity correction.</p>
  </div>
