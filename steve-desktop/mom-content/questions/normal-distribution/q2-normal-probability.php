// === NAME - DESCRIPTION: Normal Distribution Probabilities - For a normal model N(mu, sigma), compute P(X<a), P(X>b), and P(a<X<b) using standardization and the standard-normal CDF ===
...
// Pre-fix mu, sigma per scenario; pick three thresholds; let normalcdf compute probabilities
$cases = array(
  array("daily commute times in minutes", 28, 6, 22, 38, 25, 35),
  array("baby weights at birth in pounds", 7.5, 1.0, 6.5, 9.0, 7, 8.5),
  array("scores on a standardized test", 500, 100, 400, 650, 450, 600),
  array("daily steps for a fitness tracker user", 8000, 1500, 6000, 11000, 7000, 10000),
  array("body temperatures (in F)", 98.6, 0.6, 97.6, 99.2, 98, 99)
)
