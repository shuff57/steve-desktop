      ...
      <table class="rubric-table">
        <tbody>
          ...
          <tr>
            ...
            <td>We need to solve the matrix equation AX = B for X. To isolate X, multiply both sides on the left by A<sup>&minus;1</sup>.<br><b>A</b> = ' . $md . '&nbsp;&nbsp;&nbsp;<b>B</b> = ' . $bd . '</td>
          </tr>
          <tr>
            <td style="text-align:center;"><b>Step 1</b></td>
            <td><b>Find the inverse of A.</b><br>
            Use the 2&times;2 inverse formula: swap the main diagonal, negate the off-diagonal, and divide by the determinant.<br>
            <b>A<sup>&minus;1</sup></b> = ' . $mid . '</td>
          </tr>
          <tr>
            <td class="col-cat-bot" style="text-align:center;"><b>Step 2</b></td>
            <td class="col-check-bot"><b>Multiply both sides by A<sup>&minus;1</sup> to solve for X.</b><br>
            X = A<sup>&minus;1</sup>B. Perform the matrix multiplication.
