// === NAME - DESCRIPTION: Full Equation from Summary Statistics - Compute slope from r, s_x, s_y; compute intercept from means; make a prediction ===
...
$ctx_options = array(
  array("years of experience", "salary (thousands of dollars)", "years of experience", "salary"),
  array("daily calorie intake", "weight (pounds)", "daily calories", "weight"),
  array("outside temperature (&deg;F)", "monthly electric bill (dollars)", "temperature", "electric bill"),
  array("age of a car (years)", "resale value (thousands of dollars)", "age of the car", "resale value")
)
