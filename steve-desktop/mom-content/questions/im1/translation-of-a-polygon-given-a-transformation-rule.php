// === NAME - DESCRIPTION: Translation of a polygon given a transformation rule (local for Steven Huff) ===
...
$translationrule = makepretty("(x + $p, y + $q)")
...
// === QUESTION TEXT ===
<h3><span style="font-size: medium;">Consider the diagram below and plot `$image` , the image of `$object` according to the transformation rule `T(x, y) -&gt; $translationrule `.</span></h3>
