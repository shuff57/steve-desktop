// === NAME - DESCRIPTION: Tile Pattern - fill in table, find equation #1 (local for Steven Huff) ===
...
$figure1=textonimage($tile,"<span style='font-size:25px'>Fig. `$a`</span>",30,110,"<span style='font-size:25px'>Fig. `$b`</span>",210,110,"<span style='font-size:25px'>Fig. `$c`</span>",400,110)
