// === NAME - DESCRIPTION: Determining the Linear Equation from a graph -  0 slope (local for Steven Huff) ===
...
$hidetips = true;
$dir = nonzerorand(-1,1)
$slopes = array(.2,.25,.4,.5,.6,.75,.8,1.25,1.5,1.75,2,2.5,3);
$m = 0
decimaltofraction(randfrom($slopes)*$dir);
$b = nonzerorand(-8,8);
