// === NAME - DESCRIPTION: Reflections - perform a reflection given line of reflection (v2) (local for Steven Huff) ===
...
$background=$tri
$background[]="x=$lor,red" if $type==1
$background[]="y=$lor,red" if $type==2
