// === NAME - DESCRIPTION: Multiplying Fractions (no cancellation, one negative, one positive) ===
...
Since we are trying to find the product of a negative number and a positive number, the result should be negative.
