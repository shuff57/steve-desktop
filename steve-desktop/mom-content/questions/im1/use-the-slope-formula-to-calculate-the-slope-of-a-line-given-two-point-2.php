// === NAME - DESCRIPTION: Use the slope formula to calculate the slope of a line given two points. (local for Steven Huff) ===
// === SET QUESTION TYPE TO: calculated ===

// === COMMON CONTROL ===
$x1,$x2,$y1,$y2 = nonzerodiffrands(-10,10,4)
...
<div style="margin-left:2em;margin-top:1.2em;">`m =` $answerbox</div>
$hintloc
