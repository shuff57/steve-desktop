// === NAME - DESCRIPTION: Tile Pattern - fill in table, find equation #4 (local for Steven Huff) ===
...
$figure1=textonimage($tile,"<span style='font-size:15px'>Fig.`$a`</span>",30,90,"<span style='font-size:15px'>Fig. `$b`</span>",180,90,"<span style='font-size:15px'>Fig. `$c`</span>",330,90)
