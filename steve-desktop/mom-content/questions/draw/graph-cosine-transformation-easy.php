// === GRAPH COSINE TRANSFORMATION (EASY) - One transformation active. Student draws y = a cos(b(x-h)) + k over one period using the cosine curve tool. Degree mode. ===
...
$func_str = $a . "*cos(" . $b . "*(x-" . $h_deg . ")*pi/180)+" . $k
...
$dot0      = showplot("dot," . $x0 . "," . $y0 . ",closed,purple",               $x_min, $x_max, $y_min, $y_max, $xscl, "1", 480, 290)
$dot1      = showplot("dot," . $x1 . "," . $y1 . ",closed,green",                $x_min, $x_max, $y_min, $y_max, $xscl, "1", 480, 290)
$dot2      = showplot("dot," . $x2 . "," . $y2 . ",closed,red",                  $x_min, $x_max, $y_min, $y_max, $xscl, "1", 480, 290)
$dot3      = showplot("dot," . $x3 . "," . $y3 . ",closed,green",                $x_min, $x_max, $y_min, $y_max, $xscl, "1", 480, 290)
$dot4      = showplot("dot," . $x4 . "," . $y4 . ",closed,purple",               $x_min, $x_max, $y_min, $y_max, $xscl, "1", 480, 290)
