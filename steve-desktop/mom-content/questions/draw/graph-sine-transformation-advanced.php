// === GRAPH SINE TRANSFORMATION (ADVANCED) - All four transformations active. Student draws y = a sin(b(x-h)) + k over one period using the sine curve tool. Degree mode. ===
