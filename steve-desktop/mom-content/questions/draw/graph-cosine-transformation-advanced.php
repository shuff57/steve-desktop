// === GRAPH COSINE TRANSFORMATION (ADVANCED) - All four transformations active. Student draws y = a cos(b(x-h)) + k over one period using the cosine curve tool. Degree mode. ===
