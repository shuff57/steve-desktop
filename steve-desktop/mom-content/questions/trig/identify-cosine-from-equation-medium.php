// === IDENTIFY COSINE TRANSFORMATIONS (MEDIUM) - Two transformations active. Equation in degrees; ask for period and phase shift in degrees, then radian equivalents. ===
