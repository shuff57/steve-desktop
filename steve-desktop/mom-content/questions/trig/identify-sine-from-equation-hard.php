// === IDENTIFY SINE TRANSFORMATIONS (HARD) - Three transformations active. Equation in degrees; ask for period and phase shift in degrees, then radian equivalents. ===
// === SET QUESTION TYPE TO: multipart ===

// === COMMON CONTROL ===

/* ---------- 1. Hard combo (exactly 3 of {a, b, h, k} active; one left out) ---------- */
// 0:leave-out a -> {b,h,k}   1:leave-out b -> {a,h,k}
// 2:leave-out h -> {a,b,k}   3:leave-out k -> {a,b,h}
$combo = rand(0, 3)
