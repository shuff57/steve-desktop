// === IDENTIFY SINE TRANSFORMATIONS (EASY) - One transformation active. Equation in degrees; ask for period and phase shift in degrees, then radian equivalents. ===
// === SET QUESTION TYPE TO: multipart ===

// === COMMON CONTROL ===

/* ---------- 1. Easy combo (exactly 1 of {a, b, h, k} active) ---------- */
// 0:{a}  1:{b}  2:{h}  3:{k}
$combo = rand(0, 3)
