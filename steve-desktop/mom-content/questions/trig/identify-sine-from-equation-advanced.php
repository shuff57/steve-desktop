// === IDENTIFY SINE TRANSFORMATIONS (ADVANCED) - All four transformations active. Equation in degrees; ask for period and phase shift in degrees, then radian equivalents. ===
