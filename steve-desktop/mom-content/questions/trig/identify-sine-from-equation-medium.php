// === IDENTIFY SINE TRANSFORMATIONS (MEDIUM) - Two transformations active. Equation in degrees; ask for period and phase shift in degrees, then radian equivalents. ===
// === SET QUESTION TYPE TO: multipart ===

// === COMMON CONTROL ===

/* ---------- 1. Medium combo (exactly 2 of {a, b, h, k} active) ---------- */
// 0:{a,b}  1:{a,h}  2:{a,k}  3:{b,h}  4:{b,k}  5:{h,k}
$combo = rand(0, 5)
...
$h_on = 0
$k_on = 0
if ($combo == 0) { $a_on = 1; $b_on = 1 }
if ($combo == 1) { $a_on = 1; $h_on = 1 }
if ($combo == 2) { $a_on = 1; $k_on = 1 }
if ($combo == 3) { $b_on = 1; $h_on = 1 }
if ($combo == 4) { $b_on = 1; $k_on = 1 }
if ($combo == 5) { $h_on = 1; $k_on = 1 }
      ...
      <table class="rubric-table">
        <tbody>
          ...
          <tr>
            ...
            <td>The general form is <b>y = a sin(b(x &minus; h)) + k</b>.<br><br>
