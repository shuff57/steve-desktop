...
// --- Standard unit circle angles (non-axial only, 12 angles) ---
...
// Quadrant sign rules for solution
$signs = array("(+, +)", "(+, +)", "(+, +)", "(-, +)", "(-, +)", "(-, +)", "(-, -)", "(-, -)", "(-, -)", "(+, -)", "(+, -)", "(+, -)")
$sign = $signs[$i]
      ...
      <table class="rubric-table">
        <tbody>
          ...
          <tr>
            ...
            <td>The point P = `(' . $xd . ', ' . $yd . ')` is on the unit circle. We need to determine which quadrant this point lies in.</td>
          </tr>
          <tr>
            <td style="text-align:center;"><b>Step 1</b></td>
            <td><b>Identify the signs of the coordinates.</b><br>
            Look at whether the x-coordinate and y-coordinate are positive or negative. The signs are ' . $sign . '.</td>
          </tr>
          <tr>
            <td class="col-cat-bot" style="text-align:center;"><b>Step 2</b></td>
            <td class="col-check-bot"><b>Match the sign pattern to the correct quadrant.</b><br>
            Each quadrant has a unique combination of signs:
              <ul style="margin:0.3em 0 0.3em 1.2em;">
                <li>Quadrant I: (+, +)</li>
                <li>Quadrant II: (&minus;, +)</li>
                <li>Quadrant III: (&minus;, &minus;)</li>
                <li>Quadrant IV: (+, &minus;)</li>
              </ul>
              <div style="margin-top:8px;padding:0.6em 1em;background:#e8f5e9;border-left:4px solid #4CAF50;border-radius:0 6px 6px 0;">
                <b>Answer:</b> Quadrant <b>' . $quad . '</b>
              </div>
            </td>
          </tr>
        </tbody>
...
<p>In which quadrant does point P lie? Enter the quadrant number (1, 2, 3, or 4).</p>
</div>

Quadrant: $answerbox[0]
