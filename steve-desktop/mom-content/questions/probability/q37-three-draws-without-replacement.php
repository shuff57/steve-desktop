  ...
  <details>
    ...
    <div class="sol-body">
      ...
      <ul>
        ...
        <li><b>(b) At least one $c2.</b> The only way to get none is three $c1 &mdash; the path from (a), ' . $pAll . '. So at least one $c2 is `1 - ' . $pAll . ' = ' . $pAtLeastOne . '`. Adding the other seven paths gives the same number and takes seven products.</li>
        <li><b>(c) Third $c1, given the first two.</b> Two $c1 have already been removed, and two $item in total: `' . $r3 . ' -: ' . $n3 . ' = ' . $pC1Third . '`. The denominator is ' . $n3 . ' (not 10), and the numerator is ' . $r3 . ' (not ' . $r . ') &mdash; both have been reduced by what the first two draws took.</li>
...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px;">
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:20px; margin:10px 0; box-shadow:0 4px 6px -1px rgba(0,0,0,0.07),0 2px 4px -2px rgba(0,0,0,0.04);">
    <p style="margin:0 0 4px 0;">$context holds <b>$r $c1</b> and <b>$b $c2</b> $item, $total in total. Three are drawn at random, <b>without replacement</b> &mdash; none is put back.</p>
