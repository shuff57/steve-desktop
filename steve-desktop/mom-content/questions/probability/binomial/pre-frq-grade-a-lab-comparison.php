// === NAME - DESCRIPTION: Pre-FRQ Grade a Lab Comparison - A theoretical-vs-empirical comparison with a grading checklist, where the student grades four sample responses against the rubric instead of writing one ===
// === SET QUESTION TYPE TO: multipart ===

// === COMMON CONTROL ===

// The pre-FRQ for the 4.4 lab. No lab FRQ exists to mirror, so the scenario and checklist are
...
//
// The dropped category is STATE THE THEORETICAL VALUE. A student can report the empirical RF and
...
// State the Values, 4.2 Verify the Sum, 4.3 Name the Parameters -- none is this.
//
...
$sTheory = "The theoretical probability is P(X = 2) = 0.2816 from the binomial formula."
$sEmp = "The empirical relative frequency is RF(x = 2) = 9/30 = 0.3000 from the class data."
$sCompare = "The empirical value is 0.0184 higher than the theoretical one, which is the ordinary wobble of 30 repetitions — a sample lands near the theory, not on it."
...
$css = '
<style>
  .qscope44 .rubric-container { width:100%; font-family:Arial; font-size:medium; margin:1em 0; }
  .qscope44 .rubric-container details { width:100%; border:1px solid #ccc; border-radius:8px; overflow:hidden; background:#fff; }
  .qscope44 .rubric-container summary { cursor:pointer; display:block; width:100%; background:#f8f8f8; color:#333; padding:0.35em 0.6em; font-weight:bold; border-bottom:1px solid #ccc; list-style:none; }
  .qscope44 .rubric-container summary::-webkit-details-marker { display:none; }
  .qscope44 .rubric-content { padding:0.75em; background:#fafafa; }
  .qscope44 .rubric-table { border-collapse:separate; border-spacing:0; width:100%; border:1px solid #ccc; border-radius:8px; overflow:hidden; font-family:Arial; font-size:small; margin-top:10px; }
  .qscope44 .rubric-table th { background:#f2f2f2; padding:8px; text-align:center; border:1px solid #ccc; }
  .qscope44 .rubric-table td { padding:10px; border:1px solid #ccc; vertical-align:top; }
  .qscope44 .row-colored { background:#fff9ea; }
  .qscope44 .resp { border:1px solid #e5e7eb; border-radius:8px; padding:12px 14px; margin:10px 0; background:#fff; }
  .qscope44 .resp b { color:#1865f2; }
</style>'
      ...
      <table class="rubric-table">
        <tbody>
          ...
          <tr class="row-colored"><td style="text-align:center;"><b>State the Theoretical Value<br>(3 pts)</b></td>
            <td>State the probability the formula predicts for the outcome.</td></tr>
          <tr><td style="text-align:center;"><b>State the Empirical Value<br>(3 pts)</b></td>
            <td>State the relative frequency the class data actually produced.</td></tr>
...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      <p><span class="term-label">Part (a) &mdash; only one response earns all three.</span> <b>Response ' . $fullLabel . '</b> states the theoretical value, the empirical value, and the gap with its explanation. Each of the other three misses a whole category.</p>
      <p><span class="term-label">The setup, and the answer.</span> ' . $sTheory . ' ' . $sEmp . ' ' . $sCompare . '</p>
      <p><span class="term-label">Part (b) &mdash; grading Response ' . $noTheoryLabel . ' line by line.</span></p>
      <ul>
        <li><b>State the Theoretical Value &mdash; NOT earned.</b> The empirical value is reported and compared, but nowhere does the response state what the formula predicts, so the comparison has no standard.</li>
        <li><b>State the Empirical Value &mdash; earned.</b> The relative frequency from the class data is present.</li>
        <li><b>Compare and Explain the Gap &mdash; earned.</b> The gap is measured and explained as the ordinary wobble of a sample.</li>
      </ul>
      <p><span class="term-label">Part (c) &mdash; why the theoretical value is its own category.</span> The whole point of the lab is holding a measurement up against the thing it is measuring. Without the theoretical column, "close" and "far" have no meaning — the empirical value is just a number.</p>
...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px;">
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:20px; margin:10px 0; box-shadow:0 4px 6px -1px rgba(0,0,0,0.07),0 2px 4px -2px rgba(0,0,0,0.04);">
    <p style="margin:0 0 8px 0;"><b>The scenario.</b> In the playing-card experiment, 30 groups each drew 10 cards with replacement and counted diamonds. The class data shows 9 groups got exactly 2 diamonds.</p>
    <p style="margin:8px 0 0 0; padding:12px; background:#f8fafc; border:1px solid #e5e7eb; border-radius:8px;"><b>The task students were given:</b> State the theoretical probability of exactly 2 diamonds, state the empirical relative frequency from the class data, and compare the two, explaining any gap.</p>
  </div>
  $rubric
