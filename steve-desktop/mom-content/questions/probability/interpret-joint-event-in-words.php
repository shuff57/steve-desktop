...
<div style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  ...
  <p>`' . $evA . ' and ' . $evB . '` is the event that one randomly selected customer will ' . $verb . ' ' . $itemA . ' <i>and</i> ' . $verb . ' ' . $itemB . ': the same visit, both items.</p>
  <p><b>Compare it with the conditional.</b> `' . $evB . '|' . $evA . '` is restricted to the customers who ' . $ordersA . ' and asks what fraction of <i>them</i> ' . $alsoB . '. `' . $evA . ' and ' . $evB . '` is about <i>all</i> customers and asks what fraction do both. Same overlap, different denominator: which is why `P(' . $evB . '|' . $evA . ') = ' . $pcond . '` while `P(' . $evA . ' and ' . $evB . ') = ' . $pand . '`.</p>
