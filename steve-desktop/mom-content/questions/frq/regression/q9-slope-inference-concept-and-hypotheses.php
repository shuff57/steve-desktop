// === NAME - DESCRIPTION: Inference for the Slope - Concept and Hypotheses - Students explain what a hypothesis test for the slope of a regression line is trying to determine, apply the idea to a randomized real-world bivariate scenario, and state the null and alternative hypotheses using &#946;&#8321; notation. ===
...
$context_phrases = array(
  "a college instructor wonders whether the number of hours a student studies per week is linearly related to their final exam score",
  "a marketing analyst wants to know whether monthly ad spend (in $1000s) has a real linear relationship with monthly sales (in $1000s) at retail stores",
  "a wellness researcher wonders whether weekly exercise hours are linearly related to resting heart rate in adults"
);

$populations = array(
  "all college students at the university",
  "all retail stores in the chain",
  "all adults in the target community"
);

$x_vars = array(
  "hours studied per week",
  "monthly ad spend (in $1000s)",
...
$x_units = array("hours per week", "thousands of dollars", "hours per week");
$y_units = array("points", "thousands of dollars", "bpm");

$sample_actions = array(
  "randomly select students, record how many hours each one studied per week, and record their final exam score",
  "randomly select stores, record each store's monthly ad spend, and record that store's monthly sales",
  "randomly select adults, record how many hours each one exercises per week, and measure their resting heart rate"
);
