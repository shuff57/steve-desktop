// === NAME - DESCRIPTION: At Most Three Which Table - the proportion at most 3, then which table shows it and why ===
...
$questions[1] = array(
  "The ungrouped table only. The grouped table cannot show the at-most-3 share, so the cumulative entry on the 3 movies row is the only route.",
  "The grouped table only. The ungrouped table cannot show the at-most-3 share, so the cumulative entry on the 2-3 row is the only route.",
  "Either table. The cut at 3 lands exactly on the boundary between the 2-3 and 4-5 groups, so both tables give $c3d.",
...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px;">
  ...
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:20px; margin:10px 0;">
    <span style="display:inline-block; background:#e8f0fe; color:#1865f2; border-radius:6px; padding:3px 10px; font-size:13px; font-weight:700; margin-right:10px;">a.</span> Using the tables, find the <b>percent of the data that is at most three</b>. Enter your answer as a <b>decimal</b>, e.g. 0.55. $answerbox[0]
  </div>
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:20px; margin:10px 0;">
