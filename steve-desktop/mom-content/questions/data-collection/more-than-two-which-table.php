// === NAME - DESCRIPTION: More Than Two Which Table - the share above 2 by complement, then which table shows it and why ===
...
$questions[1] = array(
  "The ungrouped table. The cumulative entry on the 2 movies row is $c2d, and the share above 2 is 1 minus that, $vald.",
  "The grouped table. The 4-5 and 6-7+ rows hold the values above 3, and that is the same share as the values above 2.",
...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px;">
  ...
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:20px; margin:10px 0;">
    <span style="display:inline-block; background:#e8f0fe; color:#1865f2; border-radius:6px; padding:3px 10px; font-size:13px; font-weight:700; margin-right:10px;">a.</span> Using the tables, find the <b>percent of the data that is more than two</b>. Enter your answer as a <b>decimal</b>, e.g. 0.45. $answerbox[0]
  </div>
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:20px; margin:10px 0;">
