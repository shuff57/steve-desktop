...
$quantA = $quantAs[$aI]
$nA = rand(6, 12)
$descA = $whoA . ' picked <b>' . $nA . '</b> ' . $popA . ' completely at random and reported the ' . $quantA . '. A second batch of <b>' . $nA . '</b>, drawn the same way, gave a noticeably different figure. The instruments were accurate and every one had the same chance of being picked &mdash; <b>' . $nA . '</b> was simply too few to pin the value down precisely.'
...
$cI = rand(0, 3)
$descC = $whoC . ' ' . $descCs[$cI] . '. Every member of the population was supposed to have an equally likely chance of being chosen, and they did not &mdash; and surveying ten times as many would not repair it.'

// --- Incident D: confounding — two factors move together across the groups ---
$descDs = array(
  "gave the new fertilizer to the east field and the old one to the west field &mdash; but the east field also gets two more hours of sun a day, so any yield difference cannot be credited to the fertilizer rather than the sunlight",
  ...
  "tested the new diet on the morning class and the old one on the evening class &mdash; but the morning class also meets twice as often, so any weight change cannot be credited to the diet rather than the extra sessions",
...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      <p>Ask two questions of each incident: <b>where did the trouble enter</b> &mdash; in choosing who to measure, in the measuring itself, or in the design &mdash; and <b>would a bigger sample fix it</b>?</p>
      <div class="term-row"><span class="term-label">Sampling error:</span> ' . $whoA . ' &mdash; selection was random and the instruments were fine. Two honest samples of ' . $nA . ' still disagree, because a sample is never exactly the population. This is the one error a larger sample really does shrink.</div>
      <div class="term-row"><span class="term-label">Nonsampling error:</span> ' . $whoB . ' &mdash; the trouble is not in the sampling process at all. ' . $devBs[$bI] . ' pushes ' . $recBs[$bI] . ' off in the same direction, so measuring more of them just piles up more wrong numbers.</div>
      <div class="term-row"><span class="term-label">Sampling bias:</span> ' . $whoC . ' &mdash; some members of the population were less likely to be chosen than others. That is the definition, and it is why a bigger sample does not help: a biased method run at ten times the scale gives a more confident wrong answer.</div>
      <div class="term-row"><span class="term-label">Confounding:</span> ' . $whoD . ' &mdash; two factors move together across the groups, so the effect of each on the response cannot be separated.</div>
      ...
      &bull; ' . $whoF . ' &mdash; the ' . $nE . ' respondents chose themselves. That is <b>voluntary response bias</b>: nobody was sampled at all, so the result measures intensity of feeling, not opinion in the population.<br>
      &bull; ' . $whoE . ' &mdash; the flattering adjective on one option steers the answer. That is <b>undue influence</b>, built into the wording of the instrument rather than into the sample.</div>
    </div>
  </details>
</div>'
...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px;">
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:20px; margin:10px 0; box-shadow:0 4px 6px -1px rgba(0,0,0,0.07),0 2px 4px -2px rgba(0,0,0,0.04);">
    ...
    <p style="margin:12px 0 0 0;"><b>Two of the incidents are not used</b> &mdash; they are real problems, but none of these four terms is their name.</p>
  </div>
  $answerbox
</div>
