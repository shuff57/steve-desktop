...
$questions = array(
  "Yes &mdash; provided the " . $sampR . " were selected by a random method rather than by convenience or self-selection.",
  "Yes &mdash; any sample of more than 1,000 is reliable regardless of how it was chosen.",
  "No &mdash; a reliable sample must include at least half the population.",
  "No &mdash; " . $sampR . " is too small a number to say anything about " . $pop . " people."
)
$answer = 0
...
<div style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <p><b>Size is necessary, not sufficient.</b> A sample of ' . $sampR . ' out of ' . $pop . ' is about ' . $pct . '% of the population &mdash; plenty large for a reliable estimate.</p>
  ...
  <p><b>Answer:</b> yes &mdash; a sample of ' . $sampR . ' is a reliable measure for a population of ' . $pop . ', provided it was drawn randomly.</p>
</div>'
