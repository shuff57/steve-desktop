...
$questions = array(
  "the " . $short . " recorded for each patient &mdash; 3, 4, 11, 15, and so on &mdash; one value per patient",
...
$solutionguide = '<div style="font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <p><b>Step 1 &mdash; recall what <i>data</i> means.</b> Data are the actual values recorded on the individuals in the study &mdash; not a summary of them, and not the question being asked.</p>
  <p><b>Step 2 &mdash; apply it here.</b> The physician recorded, for each of the ' . $n . ' patients, ' . $measure . '. Those ' . $n . ' recorded numbers are the data.</p>
  <p><b>Why each of the others is a different key term:</b></p>
  <ul>
    <li>The <b>mean</b> across the patients is a <i>statistic</i> &mdash; a number computed <i>from</i> the data, not the data.</li>
    <li>The ' . $n . ' patients are the <i>sample</i> &mdash; who was measured, not what was recorded.</li>
