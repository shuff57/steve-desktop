...
// Wrong pool A: qualitative &mdash; the value names a category instead of counting or measuring.
...
$qualwhy = array("names a team, so the value is a word rather than a number &mdash; qualitative, not quantitative", "names a brand, so the value is a category rather than a quantity", "names a color, so the value describes an attribute rather than counting anything", "names a kind of vehicle, so the value is a word rather than a number")
...
$cortext2 = $cor[$cb]
$cortext3 = $cor[$cc]
$wrong1 = $qual[$q0] . ' &mdash; ' . $qualwhy[$q0] . '.'
$wrong2 = $qual[$q1] . ' &mdash; ' . $qualwhy[$q1] . '.'
$wrong3 = $meas[$m0] . ' &mdash; ' . $measwhy[$m0] . '.'
$wrong4 = $meas[$m1] . ' &mdash; ' . $measwhy[$m1] . '.'
...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      <p><b>The rule:</b> quantitative discrete data are the result of <b>counting</b>, so they land only on certain whole values with gaps in between. The phrase <b>"the number of"</b> is the signal that something was counted. Anything read off a <b>scale, a clock, or a measuring instrument</b> is continuous &mdash; even when it is rounded to a whole number. And if the value is a word rather than a quantity, it is qualitative, not quantitative at all.</p>
      <p><b>Step 1 &mdash; Number or category?</b> Throw out anything whose value is a name or a label. Those are qualitative.</p>
      <p><b>Step 2 &mdash; Counted or measured?</b> Ask "how many?" versus "how much?" A count cannot land between whole values; a measurement can always be read more finely.</p>
...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px;">
  <div style="background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:20px; margin:10px 0; box-shadow:0 4px 6px -1px rgba(0,0,0,0.07),0 2px 4px -2px rgba(0,0,0,0.04);">
    ...
    <p style="margin:12px 0 0 0;"><b>Select every variable that is quantitative discrete data</b> &mdash; data that come from counting and can take only certain whole-number values.</p>
  </div>
  $answerbox
</div>
