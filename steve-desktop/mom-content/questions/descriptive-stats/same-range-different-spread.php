...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      <p><span class="term-label">Parts (a) and (b): the two ranges.</span> Range is largest minus smallest. Both sets run from ' . $lo . ' to ' . $hi . ', so both have a range of <b>' . $rangeA . '</b> ' . $unitWord . '. Identical.</p>
      <p><span class="term-label">Part (c): but the pictures are not the same.</span> Look at what sits BETWEEN the extremes. In ' . $nameA . ' seven of the nine values sit on or beside ' . $mid . ': the set is tightly packed, with two lone values out at the ends. In ' . $nameB . ' the nine values step evenly across the whole interval, so a typical value is genuinely far from the middle. <b>' . $nameB . ' is the more spread out</b>, and its standard deviation would be much the larger of the two.</p>
      <p><span class="term-label">Part (d): what the range cannot see.</span> The range is computed from exactly two numbers and throws the rest away. Every value between the extremes could be rearranged, piled on the mean or spread out evenly, and the range would not move at all. The standard deviation asks how far EVERY value sits from the mean, so it registers precisely the difference the range is blind to.</p>
      <p><span class="term-label">Why this matters outside the exercise.</span> ' . $consequence . '. Two summaries can agree completely and still describe different situations: which is the reason a distribution is reported with a center AND a spread, and why the spread is usually the standard deviation or the IQR rather than the range.</p>
