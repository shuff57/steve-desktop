...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      <p><span class="term-label">Part (a): which display keeps every value.</span> The <b>stem-and-leaf plot</b>, and it is the only one of the four that does. Each leaf is one observation written out in full, so the original list can be read straight back off the plot. The other three record how many fell somewhere, and once a value has been counted into a bar it can never be recovered.</p>
      <p><span class="term-label">Part (b): a categorical variable.</span> The <b>bar graph</b>. The categories are names, so the horizontal axis is a list rather than a number line: which is why the bars are drawn apart. A histogram would be wrong here: its touching bars claim the axis is continuous.</p>
      <p><span class="term-label">Part (c): change over time.</span> The <b>line graph</b>. Time runs left to right along the axis and the segments carry the eye from one period to the next, so a rise or a dip is visible immediately. Here the segments really do mean something, because time genuinely passes between the points.</p>
      <p><span class="term-label">Part (d): what a stemplot gives up.</span> Its detail is exactly its limit. Twenty values make tidy rows; two thousand make rows hundreds of digits long, and the shape everyone came for disappears. That is the moment to hand over to a histogram, which spends the same space no matter how many observations it holds. Keeping every value and staying readable are in tension, and no display wins both.</p>
