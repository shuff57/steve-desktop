...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      <p><span class="term-label">Step 1 &mdash; What informed consent actually requires.</span> A valid process has to be freely given (no coercion, and the right to walk away with no penalty), it has to disclose the real risks, it has to disclose the real design &mdash; including any placebo or inactive-treatment arm &mdash; and the person agreeing has to actually be capable of consenting, or have a legally authorized representative consent for them. Those are the four true statements.</p>
      <p><span class="term-label">Step 2 &mdash; Why the others are not enough.</span> A signature on a form and a verbal &ldquo;yes&rdquo; are only evidence that consent happened &mdash; they are not a substitute for the disclosure that has to happen first. If the risks or the study design were never explained, neither a signed form nor a spoken agreement makes the consent informed. Tying a benefit like release credit, a grade, or a promotion to agreeing is coercion dressed up as a choice: refusing has to be free of cost, and it is not free here. And consent is specific to a study &mdash; it does not roll forward automatically to whatever the research team decides to run next.</p>
      <p><span class="term-label">Step 3 &mdash; Applying it.</span> If $context recruits $population for its study, the team still has to clear all four bars above before anyone enrolls &mdash; getting a signature or a nod is not a shortcut past disclosure, capacity, or freely-given agreement.</p>
