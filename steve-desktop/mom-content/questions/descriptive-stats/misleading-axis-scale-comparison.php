...
$choices[0] = array(
  "Neither graph's vertical axis has any numbers on it, so each company's line can be stretched or squeezed to whatever height makes its growth look bigger or smaller &mdash; the two graphs may not even use the same scale.",
