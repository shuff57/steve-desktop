...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      <p><span class="term-label">Step 1: Read the raw numbers.</span> ' . $storeA . ' recorded ' . $complaintsA . ' complaints out of ' . $customersA . ' customers served that week. ' . $storeB . ' recorded ' . $complaintsB . ' complaints out of ' . $customersB . ' customers served. The two stores serve very different numbers of customers, so the raw complaint counts alone cannot be compared directly.</p>
      <p><span class="term-label">Step 2: Convert each count to a rate.</span> A rate puts both stores on the same footing: complaints per 100 customers. For ' . $storeA . ': ' . $complaintsA . ' / ' . $customersA . ' &times; 100 = ' . $rateA . ' complaints per 100 customers. For ' . $storeB . ': ' . $complaintsB . ' / ' . $customersB . ' &times; 100 = ' . $rateB . ' complaints per 100 customers.</p>
      <p><span class="term-label">Step 3: Compare the rates, not the counts.</span> ' . $storeB . '\'s rate (' . $rateB . ' per 100 customers) is higher than ' . $storeA . '\'s rate (' . $rateA . ' per 100 customers), even though the raw counts alone might have suggested a different story. The rate is what actually reflects how often a customer at each store complains.</p>
      <p><span class="term-label">Step 4: Choose the honest display.</span> A display is only fair if it shows the rate, not the raw count, which mostly reflects store size, and if both stores sit on one shared, numbered scale. Two separately-scaled graphs let each store\'s bar be drawn to whatever height fits its own picture, hiding the true comparison just as an unlabeled axis would.</p>
