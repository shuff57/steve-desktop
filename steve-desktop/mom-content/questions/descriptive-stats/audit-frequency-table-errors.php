...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      ...
      <p><span class="term-label">Step 2: Compare with the published table.</span> The published table lists ' . $e1val . ' with frequency ' . $e1pub . ' and ' . $e2val . ' with frequency ' . $e2pub . '. The correct frequencies are ' . $e1true . ' and ' . $e2true . ': each is one too low in the published version. The frequency column therefore sums to 17 instead of 19, and the cumulative relative frequencies that depend on those rows are also wrong.</p>
