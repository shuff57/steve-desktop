...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      <p><span class="term-label">Part (a) &mdash; the mode of a category.</span> The mode is the value that occurs most often, and it does not have to be a number. Here ' . $topName . ' was recorded more than any other, so the mode is <b>' . $topName . '</b>. Note what the mode is NOT: it is the category, not the count. Answering with the frequency is the most common mistake on this part.</p>
      <p><span class="term-label">Part (b) &mdash; why the other two are unavailable.</span> The mean needs you to ADD the values and divide; the median needs you to put them IN ORDER and take the middle. Neither operation means anything for ' . $varName . ' &mdash; there is no sum of ' . $k0 . ' and ' . $k1 . ', and no reason one comes before the other. So for a qualitative variable the mode is the only measure of center there is.</p>
      <p>Numbering the categories 1, 2, 3, 4 does not rescue this. Those numbers are labels, and averaging labels produces a number that answers no question &mdash; a "mean color" of 2.4 is not a color.</p>
      <p><span class="term-label">Part (c) &mdash; two modes at once.</span> In that list both ' . $d0 . ' and ' . $d3 . ' appear three times, and no value appears more. When two values tie for the most common the data set is <b>bimodal</b> and both are reported. A data set can have one mode, several, or &mdash; when every value appears exactly once &mdash; none at all. That is unlike the mean and the median, which are always single numbers when they exist.</p>
