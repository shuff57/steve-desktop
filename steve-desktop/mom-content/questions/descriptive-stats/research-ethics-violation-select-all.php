...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      <p><span class="term-label">Step 1: IRB approval.</span> Every planned study must be reviewed and approved by an Institutional Review Board before it begins, to protect the human subjects in it. Enrolling volunteers before that review happened is a real violation, no matter how the study turns out.</p>
      <p><span class="term-label">Step 2: Informed consent.</span> Informed consent means the risks of participation are clearly explained to subjects before they agree to take part. Leaving out $risk, a known side effect, means the volunteers never got to weigh that risk when they consented. That is a real violation too.</p>
      <p><span class="term-label">Step 3: Data honesty.</span> Discarding the $numDiscarded scores that did not fit the expected result, and reporting conclusions from only the remaining $keptN, is exactly the kind of selective reporting that makes published findings meaningless: it is a form of data fraud, whether or not any number was directly altered.</p>
      <p><span class="term-label">Step 4: Rule out the rest.</span> The sample size ($n) might be small, but that is a question about how far the conclusion generalizes, not an ethics or procedure violation. Extra course credit is a routine incentive, not coercion, unless refusing it carries a penalty. A placebo-controlled comparison group is good experimental design, not a violation. And a study not yet being published is completely normal and says nothing about how it was conducted.</p>
