...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      ...
      <p><span class="term-label">Reading the comparison.</span> With both graphs on the same vertical scale, the ' . $gA . ' pile up toward the left of the axis and the ' . $gB . ' toward the right &mdash; so the ' . $gB . ' spend more, and the difference is in the centre of each distribution rather than in how spread out they are.</p>
