...
// (a) is a calculation, so it is typed in: offering percents to choose between would
...
$choices[1] = array(
  ...
  "<b>Voluntary response bias.</b> Nobody was selected at all: the respondents put themselves into the sample by choosing to respond, so the result over-represents whoever felt strongly enough to participate.",
...
$whoAll = array(
  "The <i>sampling</i> was flawless: " . $contacted . " alumni drawn at random from the full graduate list. What went wrong happened afterwards. Returning a paper survey costs a stamp and an evening, so the " . $responded . " who wrote back skew toward alumni with a strong attachment to the department and time on their hands. Recent graduates, the very busy, and anyone indifferent about the department are <b>under-represented</b>; the loyal and the leisured are <b>over-represented</b>. The " . $missing . " who never replied are not a random slice of the " . $contacted . ": they are the ones for whom replying was not worth it.",
  "The <i>sampling</i> was flawless: " . $contacted . " students drawn at random from the roster. But the " . $responded . " who filled the form in are no longer a random sample of students; they are a sample of <i>students who answer college email</i>, which is a different population with different habits. Organized, engaged students who read their mail are <b>over-represented</b>; students who ignore college email, often the ones whose study habits the survey most wanted to measure, are <b>under-represented</b> or missing entirely.",
  "Nobody was sampled here. The pop-up appears and each viewer decides whether to tap it, so the " . $responded . " ratings come from whoever felt like rating. Worse, the pop-up only appears to viewers who <i>finished</i> the episode: anyone who disliked the show enough to stop watching never saw it. Enthusiasts are <b>over-represented</b>, people who quit partway are <b>missing entirely</b>, and the large middle group who thought it was fine simply watched and moved on. The average describes finishers who chose to rate, not viewers.",
  "Nobody was selected here. The " . $responded . " callers put themselves into the sample, and people who are angry about a tax pick up the phone at far higher rates than people who mildly favor it or do not care. Listeners with intense opinions, and opponents in particular, are <b>over-represented</b>; the indifferent majority is <b>under-represented</b>. The percentage measures intensity of feeling among listeners motivated to call, not opinion among listeners, and certainly not opinion among residents.",
  "This is what the defense against nonresponse actually looks like: a random sample, then <i>persistence</i>. Going back up to three times reaches the people who happened to be out the first time: exactly the households a single visit would have quietly dropped. Some nonresponse remains in principle, since the " . $missing . " never reached are probably the rarely-home, but with " . $responded . " of " . $contacted . " there is not enough missing for it to move the result much.",
  "This is what the defense against nonresponse actually looks like: a random sample, then <i>persistence</i>. Return visits reach the voters who were out the first time: exactly the people a single attempt would have quietly dropped. Some nonresponse remains in principle, since the " . $missing . " never reached are probably the hardest to find at home, but with " . $responded . " of " . $contacted . " there is not enough missing for it to move the result much."
)
$whoText = $whoAll[$ci]

// Why the two rejected options are wrong, for this design.
$whyNotAll = array(
  "It is not <b>voluntary response bias</b>, because the alumni did not put themselves forward: they were chosen at random and then invited. Self-selection entered only at the reply stage, which is what makes this the milder-sounding but still fatal cousin. And it is not <b>neither</b>: at " . $rateR . "%, more than three quarters of the drawn sample is missing.",
  "It is not <b>voluntary response bias</b>, because the students did not put themselves forward: they were drawn at random and then contacted. Self-selection entered only at the reply stage. And it is not <b>neither</b>: at " . $rateR . "%, the overwhelming majority of the sample that was drawn never answered.",
  "It is not <b>nonresponse bias</b> in the strict sense, because there was never a sample to fail to respond to: no one was selected. Voluntary response is nonresponse bias with the dial turned all the way up: the entire sample is self-chosen. And it is certainly not <b>neither</b>: a " . $rateR . "% response rate on a self-selected pool is the weakest evidence on this list.",
  "It is not <b>nonresponse bias</b> in the strict sense, because no sample was ever drawn: there was nobody selected who could fail to answer. Voluntary response is nonresponse bias with the dial turned all the way up: the whole sample chose itself. And it is not <b>neither</b>: " . $rateR . "% of listeners calling in is not a sample of listeners.",
  "It is not <b>voluntary response bias</b>: the households were chosen by the researcher, not by themselves. And it is not really <b>nonresponse bias</b> either: a " . $rateR . "% response rate leaves only " . $missing . " of " . $contacted . " households unaccounted for, far too few to swing the result.",
  "It is not <b>voluntary response bias</b>: the voters were chosen by the health department, not by themselves. And it is not really <b>nonresponse bias</b> either: a " . $rateR . "% response rate leaves only " . $missing . " of " . $contacted . " voters unaccounted for, far too few to swing the result."
)
...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      ...
      <p><b>The fix, when there is one:</b> the cure for a low response rate is <i>persistence</i>, callbacks, follow-ups, going back to the people already drawn, not a larger initial mailing. Mailing twice as many surveys and getting the same low rate just doubles the size of a sample of people who like answering surveys.</p>
    </div>
  </details>
</div>'
