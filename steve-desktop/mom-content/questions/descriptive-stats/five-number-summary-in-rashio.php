// === NAME - DESCRIPTION: Build a Five-Number Summary in raSHio - Paste an unsorted data set into raSHio's summary tool, read the quartiles and median off it, compute the interquartile range, and say which of those the middle half of the data lies between ===
...
// between two values can give raSHio one answer and the textbook formula another. At n = 19 the
// (n+1) rule and the split-at-the-median rule agree exactly, so the tool and the method cannot
// disagree and the student is never punished for trusting the software.
$n = 19
$sorted = array()
$v = rand(12, 25)
for ($j=0..18) {
...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      <p><span class="term-label">What the tool does for you.</span> raSHio sorts the ' . $n . ' values and returns the five-number summary: minimum <b>' . $minV . '</b>, `Q_1` <b>' . $q1 . '</b>, median <b>' . $med . '</b>, `Q_3` <b>' . $q3 . '</b>, maximum <b>' . $maxV . '</b>. Sorting by hand is the slow part and the part where mistakes happen, so this is exactly the job to hand over.</p>
...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px;">
  ...
  <div style="background:#eff6ff; border:1px solid #bfdbfe; border-radius:12px; padding:18px; margin:10px 0;">
    ...
    <p style="margin:0;">Open <b>rashio.app</b>, choose the five-number summary, and paste the data in. It will sort the values and report the minimum, `Q_1`, the median, `Q_3` and the maximum. Then answer from what it gives you &mdash; and check one of them by hand against `i = (k/100)(n+1)`, which for these $n values puts the quartiles exactly on the 5th, 10th and 15th sorted readings.</p>
  </div>
