...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      ...
      <p><span class="term-label">Part (c).</span> Being ' . $localName . ' means standing at or above the ' . $localCut . 'th percentile of ' . $localWord . '. That leaves 100 &minus; ' . $localCut . ' = <b>' . $localShare . '%</b> &mdash; and it is ' . $localShare . '% of <i>every</i> school, large or small, because each one is measured against its own students rather than against the whole state.</p>
