...
<div class="sol-wrap" style="font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Arial,sans-serif; font-size:16px; line-height:1.6; color:#21242c; max-width:688px; margin:1em 0;">
  <details>
    ...
    <div class="sol-body">
      <p><span class="term-label">The rule, and it is the other one.</span> Finding a percentile from a rank uses `i = (k/100)(n+1)`. Going the other way &mdash; you are handed a value and asked where it sits &mdash; uses `(x + 0.5y)/n xx 100`, where `x` counts the values strictly below it, `y` counts the values equal to it, and `n = ' . $n . '`.</p>
      <p><span class="term-label">Part (a) &mdash; a value that appears twice.</span> Counting from the bottom, <b>' . $aBelow . '</b> values are below ' . $aVal . ' and <b>' . $aEqual . '</b> are equal to it. So `(' . $aBelow . ' + 0.5(' . $aEqual . '))/' . $n . ' xx 100 = ' . $aRawShown . '`, which rounds to the <b>' . $aPct . 'th percentile</b>. Taking `y = 1` here because it is "one value" is the usual slip; ' . $aVal . ' occupies two positions in the list.</p>
      <p><span class="term-label">Part (b) &mdash; a value that appears once.</span> ' . $bBelow . ' values are below ' . $bVal . ' and ' . $bEqual . ' equals it: `(' . $bBelow . ' + 0.5(' . $bEqual . '))/' . $n . ' xx 100 = ' . $bRawShown . '`, so the <b>' . $bPct . 'th percentile</b>.</p>
      <p><span class="term-label">Part (c) &mdash; why the half.</span> A repeated value fills several positions at once. Counting all of them would push it too high and counting none too low, so half of them is the honest middle. With one occurrence the half adds 0.5 to a count of ' . $n . ' &mdash; small, but it is the same rule.</p>
