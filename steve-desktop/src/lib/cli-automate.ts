...
export function buildAutomateExecPrompt(o: AutomateExecOptions): string {
  ...
  return [
    ...
    '',
    'The user is watching: the app shows a green cursor + "agent connected" badge automatically and',
    'tracks your mouse for you — you do not need to manage any cursor. Prefer real CDP Input mouse',
    'events at the element centre over el.click() so the tracked cursor lands on your target.',
    '',
    'HARD RULES:',
